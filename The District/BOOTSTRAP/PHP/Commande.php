...
<body>
    ...
    <div class="container mt-5 p-5" style="justify-content: center;">
        <div class="card mb-5 text-center mx-auto p-2" style="max-width: 700px; background-color:#ff8c00">
            <div class="row g-0">
                <div class="col-md-4">
                    <img src="../platscategorieimag/img-salade/salade-césar-maison.webp" class="img-fluid" alt="...">
                    <!--si on delete pill the will ne behind another plac of color-->
                </div>
                <div class="col-md-8">
                    <div class="card-body">
                        <h4 class="card-title">Nom du Plat</h4>
