...
<body>
    ...
    <div class="col-md-12">
        ...
        <option>Serge Gainsbourg</option> 
        <option>AC/DC</option> 
        <option>Marillion</option> 
        <option>Bob Dylan</option> 
        <option>Fleshtones</option> 
        <option>The Clash</option> 
        ...
        <button type="submit" class="btn btn-primary btn-sm float-start">Ajouter</button>
        
        <!-- <button type="button" onclick="location.href='index.php'">Retour</button> -->
        <button type="submit" class="btn btn-primary  btn-sm float-start" onclick="location.href='index.php'" >Retour</button>
